...
- **Languages**: python: 89, json: 6, yaml: 6, shell: 5, toml: 2
...
- `src.redup.cli_app.main.scan` - 20 calls
...
- `src.redup.core.pipeline.duplicate_finder.find_duplicates_phase_lazy` - 10 calls
