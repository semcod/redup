...
class FunctionExtractor:
    ...
    def __init__(
        ...
        extract_class_name: Callable[[Any], str | None] | None = None,
    ):
        """
    ...
    def _create_method_block(
        self, node: Any, source_lines: list[str], file_path: str, class_name: str | None
    ) -> CodeBlock | None:
...
def _extract_java_class_name(node: Any) -> str | None:
...
GO_EXTRACTOR = FunctionExtractor(function_node_types=["function_declaration"], method_node_types=[])

RUST_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_item"], method_node_types=["method_declaration"]
)
...
SCALA_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_definition"], method_node_types=["method_definition"]
)

KOTLIN_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_declaration"], method_node_types=["function_declaration"]
)

SWIFT_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_declaration"], method_node_types=["method_declaration"]
)

OBJC_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_definition"], method_node_types=["method_declaration"]
)

LUA_EXTRACTOR = FunctionExtractor(
    function_node_types=["function_declaration", "local_function"], method_node_types=[]
)
