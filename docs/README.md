...
![version](https://img.shields.io/badge/version-0.1.0-blue) ![python](https://img.shields.io/badge/python-%3E%3D3.10-blue) ![coverage](https://img.shields.io/badge/coverage-unknown-lightgrey) ![functions](https://img.shields.io/badge/functions-155-green)
> **155** functions | **20** classes | **31** files | CC̄ = 3.9
...
```
redup/
    ├── 01_basic_usage        ├── __main__    ├── redup/├── benchmark        ├── core/            ├── config            ├── planner            ├── scanner            ├── parallel_scanner    ├── sitecustomize            ├── models            ├── hasher            ├── lsh_matcher            ├── ts_extractor            ├── differ            ├── markdown_reporter            ├── code2llm_reporter            ├── matcher        ├── reporters/            ├── json_reporter            ├── enhanced_reporter            ├── yaml_reporter        ├── cli_app/            ├── toon_reporter            ├── utils/                ├── hash_utils                ├── duplicate_finders├── project            ├── main                ├── function_extractor            ├── pipeline```
