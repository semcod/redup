...
```
redup/
    ├── 01_basic_usage        ├── __main__    ├── redup/├── benchmark        ├── core/            ├── config            ├── planner            ├── scanner            ├── parallel_scanner            ├── models    ├── sitecustomize            ├── hasher            ├── pipeline            ├── lsh_matcher            ├── matcher            ├── markdown_reporter        ├── reporters/            ├── json_reporter            ├── differ            ├── yaml_reporter        ├── cli_app/            ├── toon_reporter            ├── enhanced_reporter            ├── utils/                ├── hash_utils                ├── function_extractor                ├── duplicate_finders├── project            ├── ts_extractor            ├── main```
